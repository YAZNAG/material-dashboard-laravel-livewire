                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <ul class="nav nav-tabs nav-tabs-custom" role="tablist">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" data-bs-toggle="tab" href="#CartesGrise" role="tab">
                                        Les cartes grises
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" data-bs-toggle="tab" href="#cartAutorisation" role="tab">
                            ...
                            <div class="tab-content p-3">
                                ...
                                <div class="tab-pane active" id="assurances" role="tabpanel">
                                    <div class="mb-4 text-end">
                                        <a href="{{ route('assurances.create') }}" class="btn btn-primary mb-3">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        @if ($assurance->assurence_image)
                                                            <a href="{{ Storage::url($assurance->assurance_image) }}" download class="btn btn-success">
                                ...
                                <div class="tab-pane" id="taxes" role="tabpanel">
                                    <div class="mb-4 text-end">
                                        <a href="{{ route('taxes.create') }}" class="btn btn-primary mb-3">
                                            <i class="material-icons">add</i> Ajouter
                                        </a>
                                    </div>
                                    <div class="table-responsive mb-4">
                                        <table class="table table-striped table-bordered align-items-center">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        @if ($taxe->taxe_image)
                                                            <a href="{{ Storage::url($taxe->taxe_image) }}" download class="btn btn-success">
                                                                <i class="material-icons">download</i> Télécharger
                                                            </a>
                                                        @endif
                                                    </td>
                                                    <td>
                                                        ...
                                                        <form action="{{ route('taxes.destroy', $taxe->id) }}" method="POST" style="display:inline;">
                                                            @csrf
                                                            @method('DELETE')
                                                            <button type="submit" class="btn btn-danger" onclick="return confirm('Êtes-vous sûr de vouloir supprimer cette taxe?')">
                                                                <i class="material-icons">delete</i>
                                                            </button>
                                                        </form>
                                                    </td>
                                ...
                                <div class="tab-pane" id="visites" role="tabpanel">
                                    <div class="mb-4 text-end">
                                        <a href="{{ route('visites.create') }}" class="btn btn-primary mb-3">
                                            <i class="material-icons">add</i> Ajouter
                                        </a>
                                    </div>
                                    <div class="table-responsive mb-4">
                                            ...
                                            <tbody>
                                                @foreach ($visitesTechnique as $visite)
                                                                                                                               <tr>
                                                                                                                                   ...
                                                                                                                                   <td>
                                                                                                                                       @if ($visite->visite_image)
                                                                                                                                           <a href="{{ asset('storage/images/camions/visites/' . basename($visite->visite_image)) }}" download class="btn btn-success">Télécharger</a>
                                                                                                                                       @endif
                                                                                                                                   </td>
                                                                                                                                   <td>
                                                                                                                                       <a href="{{ route('visites.edit', $visite->id) }}" class="btn btn-warning">
                                                                                                                                           <i class="material-icons">edit</i> <!-- Icon for Edit -->
                                                                                                                                       </a>
                                                                                                                                       <form action="{{ route('visites.destroy', $visite->id) }}" method="POST" style="display:inline;">
                                                                                                                                           @csrf
                                                                                                                                           @method('DELETE')
                                                                                                                                           <button type="submit" class="btn btn-danger" onclick="return confirm('Êtes-vous sûr de vouloir supprimer cette visite technique?')">
                                                                                                                                               <i class="material-icons">delete</i> <!-- Icon for Delete -->
                                                                                                                                           </button>
                                                                                                                                       </form>
                                                                                                                                   </td>
                                                                                                                               </tr>
                                                                                                               ...
                                                                                                               <div class="tab-pane" id="CartesGrise" role="tabpanel">
                                                                                                                   <div class="mb-4 text-end">
                                                                                                                       <a href="{{ route('cartesgrise.create') }}" class="btn btn-primary mb-3">
                                                                                                                           <i class="material-icons">add</i> Ajouter
                                                                                                                       </a>
                                                                                                                   </div>
                                                                                                                   <div class="table-responsive mb-4">
                                                                                                                       <table class="table table-striped table-bordered align-items-center">
                                                                                                                           ...
                                                                                                                           <tbody>
                                                                                                                               ...
                                                                                                                               <tr>
                                                                                                                                   ...
                                                                                                                                   <td>
                                                                                                                                       <a href="{{ route('cartesgrise.edit', $carte->id) }}" class="btn btn-warning">
                                                                                                                                           <i class="material-icons">edit</i> <!-- Icon for Edit -->
                                                                                                                                       </a>
                                                                                                                                       <form action="{{ route('cartesgrise.destroy', $carte->id) }}" method="POST" style="display:inline;">
                                                                                                                                           @csrf
                                                                                                                                           @method('DELETE')
                                                                                                               ...
                                                                                                               <div class="tab-pane" id="cartAutorisation" role="tabpanel">
                                                                                                                   <div class="mb-4 text-end">
                                                                                                                       <a href="{{ route('cartesautorisation.create') }}" class="btn btn-primary mb-3">
                                                                                                                           <i class="material-icons">add</i> Ajouter
                                                                                                                       </a>
                                                                                                                   </div>
                                                                                                                   <div class="table-responsive mb-4">
                                                                                                                       <table class="table table-striped table-bordered align-items-center">
                                                                                                                           ...
                                                                                                                           <tbody>
                                                                                                                               ...
                                                                                                                               <tr>
                                                                                                                                   ...
                                                                                                                                   <td>
                                                                                                                                       <a href="{{ route('cartesautorisation.edit', $autorisation->id) }}" class="btn btn-warning">
                                                                                                                                           <i class="material-icons">edit</i> <!-- Icon for Edit -->
                                                                                                                                       </a>
                                                                                                                                       <form action="{{ route('cartesautorisation.destroy', $autorisation->id) }}" method="POST" style="display:inline;">
                                                                                                                                           @csrf
                                                                                                                                           @method('DELETE')
