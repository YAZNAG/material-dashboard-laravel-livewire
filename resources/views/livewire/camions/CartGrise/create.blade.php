<x-layouts.base>
    ...
    <div class="main-content position-relative max-height-vh-100 h-100 border-radius-lg">
        ...
        <div class="container-fluid py-4">
            <div class="row">
                <div class="col-12">
                    <h1 class="text-center mb-4">Ajouter une Carte Grise</h1>

                    <!-- Form for creating a new carte grise -->
                    <div class="card">
                        <div class="card-body">
                            <form action="{{ route('cartesgrise.store') }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                ...
                                <!-- Image Upload -->
                                <div class="mb-3">
                                    <label for="image_path" class="form-label">Image de la Carte Grise</label>
                                    <input type="file" class="form-control" id="image_path" name="image_path" accept="image/*" required>
                                </div>

                                <!-- Submit Button -->
                                <button type="submit" class="btn btn-primary">Ajouter Carte Grise</button>
                            </form>
                        </div>
                    </div>
                </div>
